...
```c
fseek(file, 0, SEEK_END); // Zeiger ans Dateiende setzen  
int n = ftell(file) / sizeof(tStud); // Byte Offset / Größe = gesamt 
rewind(file); // Zeiger wieder an den Dateianfang setzen  
```
