...
% ============================================================
\section{Professionelle Tabellen mit booktabs}
\label{sec:booktabs}
% ============================================================

Das Paket \texttt{booktabs} bietet horizontale Linien in verschiedenen Dicken:
...
\subsection{Teilstriche mit booktabs}

\begin{table}[htbp]
    \centering
    \caption{Tabelle mit \texttt{cmidrule}}
    \label{tab:cmidrule}
    \begin{tabular}{llrr}
        \toprule
...
% ============================================================
\section{Zellen verbinden}
\label{sec:verbinden}
% ============================================================

\subsection{Spalten verbinden (multicolumn)}

\begin{table}[htbp]
    \centering
    \caption{Spalten mit \texttt{multicolumn} verbunden}
...
\subsection{Zeilen verbinden (multirow)}

\begin{table}[htbp]
    \centering
    \caption{Zeilen mit \texttt{multirow} verbunden}
    \label{tab:multirow}
    \begin{tabular}{llr}
        \toprule
...
\subsection{Zeilen und Spalten gleichzeitig}
...
% ============================================================
\section{Spaltenbreite und Textumbruch}
\label{sec:spaltenbreite}
% ============================================================

\subsection{Feste Spaltenbreite mit Umbruch}

Mit \texttt{p\{...\}} wird der Text in der Spalte umgebrochen:
...
\subsection{Zentrierter Umbruch mit m-Spalten}

\begin{table}[htbp]
    \centering
    \caption{Vertikal zentrierte \texttt{m}-Spalten}
    \label{tab:m-spalten}
