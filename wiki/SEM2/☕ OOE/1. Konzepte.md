...
> [!example] Praxisbeispiel: [[2. Übungen OOE#2.2 Erwärmung 2: Fernbedienung|Interface-Implementierung (Fernbedienung)]]
...
> [!example] Übung: [[2. Übungen OOE#2.1 Erwärmung 1: Vererbung vs. Komposition|Vererbung vs. Komposition]] und [[2. Übungen OOE#2.3 Smart-Home Refactoring|Smart-Home Refactoring (Delegation)]]
...
> [!example] Übung: [[2. Übungen OOE#2.6 Typensicherer Frachter|Generics am Beispiel eines Frachters]]
